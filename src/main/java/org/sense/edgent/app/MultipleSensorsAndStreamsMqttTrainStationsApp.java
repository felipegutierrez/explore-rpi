...
public class MultipleSensorsAndStreamsMqttTrainStationsApp {
	...
	public MultipleSensorsAndStreamsMqttTrainStationsApp(String ipAddress, String port) {
		...
		TStream<String> tempReadingsStation01Trains = sensor12Readings.union(sensor13Readings);
		TStream<String> tempReadingsStation01Tickets = sensor14Readings.union(sensor15Readings);
		...
		TStream<String> tempReadingsStation02Trains = sensor32Readings.union(sensor33Readings).union(sensor34Readings);
		TStream<String> tempReadingsStation02Tickets = sensor32Readings.union(sensor33Readings).union(sensor34Readings);
		// @formatter:on
